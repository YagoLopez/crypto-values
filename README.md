...
Run `nx g @nrwl/react:app crypto-values` to generate an application.
...
Libraries are shareable across libraries and applications. They can be imported from `@crypto-values/mylib`.
...
Run `nx g @nrwl/react:component my-component --project=crypto-values` to generate a new component.
...
Run `nx e2e crypto-values` to execute the end-to-end tests via [Cypress](https://www.cypress.io).
